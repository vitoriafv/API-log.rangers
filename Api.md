...
|04|     Alta       |	Como tomador de decisões de políticas públicas, quero visualizar um layout no Power BI, com divisão de dados por Estado para analisar a distribuição regional dos acidentes.|      2     |        2    |      RN.P.1 | [ ]
