...
|05|     Alta        | Como tomador de decisões de políticas públicas, quero visualizar um layout no Power BI, com divisão de dados por Estado para analisar os tipos de cargas, com origem e destino. |     3      |    2     |     RN.P.2       | [ ]
|06|      Alta      | Como tomador de decisões e políticas públicas, quero acessar as localidades com maiores índices de acidentes com veículos pesados, para definir prioridades de fiscalização e investimentos. |        2      |      3      |       RN.P.5       | |[MVP](https://github.com/user-attachments/assets/7c483a93-8722-4dc8-9014-a8eeebdd5c7e) | 
|07|      Média      |	Como tomador de decisões de políticas públicas, quero identificar as origens e destinos mais frequentes dos acidentes, para definir pontos prioritários de fiscalização e políticas preventivas. |     3      |      3      |       RN.P.6       | [ ]
|08|    Média    | Como tomador de decisões e políticas públicas, quero visualizar as causas dos acidentes viários, para identificar padrões e apoiar ações de prevenção. |         6     |      3     |       RN.P.4      | [ ]
|09|       Média      | Como tomador de decisões e políticas públicas, quero utilizar uma plataforma de BI com informações sobre acidentes viários com veículos pesados no Brasil, para analisar estatísticas e embasar decisões estratégicas.|    6    |      3    |    RN.P.3      |  [MVP](https://github.com/user-attachments/assets/456837a0-f30a-4d9c-bd5b-aa1ed6bddff1) | 
|10|     Baixa        | Como tomador de decisões e políticas públicas, quero uma visualização gráfica interativa dos acidentes nos municípios de São Paulo (2021–2025), para avaliar tendências regionais e apoiar o planejamento logístico. |     3      |    4     |     RN.P.2       | [ ]
|11|      Baixa   |	Como tomador de decisões de políticas públicas, quero saber quais empresas mais movimentam que são registradas no R.A.P., para planejar investimentos em logística e infraestrutura portuária. |      2      |       4     | RN.P.3|[ ]
