...
|05|     Alta        | Como tomador de decisões de políticas públicas, quero uma base de dados separadas para unidades de medida padronizadas em colunas distintas para quilogramas e volume, para que eu possa analisar as informações com precisão e tomar decisões mais embasadas. |     3      |    2     |     RN.P.2       | [ ]
...
|07|      Alta      | Como tomador de decisões e políticas públicas, quero acessar as localidades com maiores índices de acidentes com veículos pesados, para definir prioridades de fiscalização e investimentos. |        2      |      3      |       RN.P.5       | |[MVP](https://github.com/user-attachments/assets/7c483a93-8722-4dc8-9014-a8eeebdd5c7e) | 
|08|      Média      |	Como tomador de decisões de políticas públicas, quero identificar as origens e destinos mais frequentes dos acidentes, para definir pontos prioritários de fiscalização e políticas preventivas. |     3      |      3      |       RN.P.6       | [ ]
