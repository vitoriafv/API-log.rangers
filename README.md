...
|04|     Alta       |	Como tomador de decisões de políticas públicas, quero visualizar um layout no Power BI, com divisão de dados por Estado para analisar os tipos de cargas, com origem e destino. |      2     |        2    |      RN.P.1 | [ ]
|05|     Alta        | Como tomador de decisões de políticas públicas, quero uma base de dados atualizada e organizada, para que as informações estejam divididas em colunas específicas para cargas perigosas e não perigosas, facilitando a análise e tomada de decisões |     3      |    2     |     RN.P.2       | [ ]
