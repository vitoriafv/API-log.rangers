...
|03|     Alta       |	Como tomador de decisões de políticas públicas, quero visualizar os dados tratados no Power BI, para avaliar o layout.|      2     |        1    |      RN.P.1 | [ ]
|04|     Alta       |	Como tomador de decisões de políticas públicas, quero uma base de dados atualizada e organizada, para que as informações estejam divididas em colunas específicas para cargas perigosas e não perigosas, facilitando a análise e tomada de decisões. |      2     |        2    |      RN.P.1 | [ ]
|05|     Alta        | Como tomador de decisões de políticas públicas, quero uma base de dados separadas para unidades de medida padronizadas em colunas distintas para quilogramas e volume, para analisar as informações com precisão e tomar decisões mais embasadas. |     3      |    2     |     RN.P.2       | [ ]
|06|     Alta        | Como tomador de decisões de políticas públicas, quero visualizar um layout no Power BI, com divisão de dados por Estado para analisar os tipos de cargas, com origem e destino. |     3      |    2     |     RN.P.2       | [ ]
|07|      Média   |	Como tomador de decisões de políticas públicas, quero saber quais empresas mais movimentam que são registradas no R.A.P.P., para planejar investimentos em logística e infraestrutura portuária. |      2      |       2    | RN.P.3|[ ]
|08|      Alta      | Como tomador de decisões e políticas públicas, quero acessar as localidades com maiores índices de acidentes com veículos pesados, para definir prioridades de fiscalização e investimentos. |        2      |      3      |       RN.P.5       | |[MVP](https://github.com/user-attachments/assets/7c483a93-8722-4dc8-9014-a8eeebdd5c7e) | 
|09|      Média      |	Como tomador de decisões de políticas públicas, quero identificar as origens e destinos mais frequentes dos acidentes, para definir pontos prioritários de fiscalização e políticas preventivas. |     3      |      3      |       RN.P.6       | [ ]
|10|    Média    | Como tomador de decisões e políticas públicas, quero visualizar as causas dos acidentes viários, para identificar padrões e apoiar ações de prevenção. |         6     |      3     |       RN.P.4      | [ ]
|11|       Média      | Como tomador de decisões e políticas públicas, quero utilizar uma plataforma de BI com informações sobre acidentes viários com veículos pesados no Brasil, para analisar estatísticas e embasar decisões estratégicas.|    6    |      3    |    RN.P.3      |  [MVP](https://github.com/user-attachments/assets/456837a0-f30a-4d9c-bd5b-aa1ed6bddff1) | 
|12|     Baixa        | Como tomador de decisões e políticas públicas, quero uma visualização gráfica interativa dos acidentes nos municípios de São Paulo (2021–2025), para avaliar tendências regionais e apoiar o planejamento logístico. |     3      |    4     |     RN.P.2       | [ ]
|13|      Baixa   |	Como tomador de decisões de políticas públicas, quero saber quais empresas mais movimentam que são registradas no R.A.P.P., para planejar investimentos em logística e infraestrutura portuária. |      2      |       4     | RN.P.3|[ ]
...
|02|  30/10/2025| a concluir |[MVP](https://github.com/user-attachments/assets/7c483a93-8722-4dc8-9014-a8eeebdd5c7e) | 
